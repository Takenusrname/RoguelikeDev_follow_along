...
use bracket_lib::{noise::{CellularDistanceFunction, NoiseType, FastNoise},pathfinding::DijkstraMap, random::RandomNumberGenerator};
use std::{
    cmp::{max, min},
    collections::HashMap,
};
...
pub fn apply_h_tunnel(map: &mut Map, x1: i32, x2: i32, y: i32) {
...
pub fn apply_v_tunnel(map: &mut Map, y1: i32, y2: i32, x: i32) {
