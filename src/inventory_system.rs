...
impl<'a> System<'a> for ItemCollectionSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        let (player_entity, mut gamelog, mut backpack, names, mut positions, mut wants_pickup) =
            data;
            ...
            match useitem.target {
                ...
                Some(target) => {
                    ...
                    match area_effect {
                        ...
                        Some(area_effect) => {
                            let blast_tiles = field_of_view(target, area_effect.radius, &*map);
